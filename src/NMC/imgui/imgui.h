...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, Window_Resize_Dir_Flags WRDF = (int)Window_Resize_Dir::WRD_FULL);
    IMGUI_API void          End();
